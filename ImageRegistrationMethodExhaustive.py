...
fixed = sitk.ReadImage('/Users/farid/Documents/Workspace/python/bactrace/fixed.jpg', sitk.sitkFloat32)

moving = sitk.ReadImage('/Users/farid/Documents/Workspace/python/bactrace/moving.jpg', sitk.sitkFloat32)

plt.figure()
plt.imshow(sitk.GetArrayFromImage(fixed))
plt.show()
